...
ia2001 tools for authenticated encryption.

**Overview**

Package secret provides tools for encrypting and decrypting
authenticated messages. Like all ia2001xpy packages, metrics are built in
