...
ia2011 tools for signing and authenticating HTTP requests between web services.
...
.. code-block:: py
   ...
   request_headers = {
      ...
      'ia2001xpy-Timestamp': timestamp,
      'ia2001xpy-Nonce': nonce,
      'ia2001xpy-Signature': signature,
      'ia2001xpy-Signature-Version': signature_version}
